...
def processDClientes():
    ...
    Ler os dados originais de clientes e enviar ao Supabase padronizados.
    """
    ...
    # Selecionar colunas relevantes para a nossa análise
    ...
    # Tratar valores vazios para evitar problemas futuros no Dashboard
    ...
    # Carregar no banco de dados usando a nossa função helper
